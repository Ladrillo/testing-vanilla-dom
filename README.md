...
Your must complete all of the following steps:

- [ ] Step 0 is to link `src/index.js` to the `src/index.html` file, using a script tag.
- [ ] Steps 1 and 2 are explained inside `src/components/header.js` file (create and append the header to the DOM).
- [ ] Steps 3 and 4 are explained inside `src/components/tabs.js` file (create and append the tabs to the DOM).
- [ ] Steps 5 and 6 are explained inside `src/components/cards.js` file (create and append the cards to the DOM).
...
2. Setting up your fork settings on Github to submit via Codegrade pushing commits to your `<firstName-lastName>` branch.
